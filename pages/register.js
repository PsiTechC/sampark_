...
//   const [isLoginMode, setIsLoginMode] = useState(false); // New state to manage login/register mode
...
//       {/* Left side for the registration/login form */}
...
//                   try {
//                     const result = await axios.post('/api/auth/google', { credential });
