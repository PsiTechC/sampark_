...
const headers = [
  "row", "firstName", "lastName", "callId", "customerNumber",
  "timezone", "status", "endedReason", "duration (seconds)",
  "summary", "appointmentDate", "purpose", "sentiment", "name", "email"  
];
...
const rows = batch.summary.map((r) => [
  ...
  r.duration,
  (r.summary || "").replace(/"/g, '""'),
  (r.appointmentDate && !["", "null", "undefined", "Invalid Date"].includes(r.appointmentDate))
    ? r.appointmentDate
    : "-",
  r.purpose,
  r.sentiment,
